...
const ProductCard = ({
  ...
  return (
    <div className="bg-white rounded-none sm:rounded-2xl border-0 sm:border sm:border-[#eaeaea] border-b border-b-[#eee] overflow-hidden flex flex-row h-[240px] sm:h-[300px] md:h-[280px] shadow-none sm:hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="relative w-1/2 sm:w-[35%] md:w-[40%] bg-white flex items-start min-[520px]:items-center sm:items-center justify-center pt-3 sm:pt-0 sm:p-3 md:py-2 md:pl-2 md:pr-0">
        {product.discount && (
        ...
        <img
          src={product.image}
          alt={product.name}
          className="w-[95%] h-auto sm:w-[95%] sm:h-[95%] md:w-full md:h-full min-[520px]:my-auto md:my-auto lg:my-0 lg:w-[95%] lg:h-[95%] object-contain object-top sm:object-center rounded-xl"
        />
      </div>
