...
const ProductCard = ({
  ...
  return <div className="bg-white rounded-none lg:rounded-2xl border-0 lg:border lg:border-[#eaeaea] overflow-hidden flex flex-row h-[200px] sm:h-[240px] lg:h-[280px] shadow-none lg:hover:shadow-lg transition-shadow duration-300">
      <div className="relative w-[56%] sm:w-[40%] lg:w-[40%] flex items-center justify-center p-3 h-full">
        ...
        <img src={product.image} alt={product.name} className="w-full h-full aspect-square object-contain lg:w-[90%] lg:h-[90%] lg:aspect-auto rounded-2xl" />
      </div>
      ...
      <div className="w-[44%] sm:w-[60%] lg:flex-1 py-3 pr-3 sm:py-4 sm:pr-4 lg:p-6 flex flex-col justify-between h-full">
        <div className="flex-1 flex flex-col min-h-0">
          ...
          <div className="flex items-center gap-1.5 mb-1.5 sm:mb-2">
            ...
            {product.originalPrice && <span className="text-[#999] text-[12px] sm:text-[13px] lg:text-sm line-through">
        ...
        <Button variant={isInCart ? "outline" : "default"} className="w-full rounded-full gap-2 text-[13px] sm:text-[14px] lg:text-sm mt-auto py-2.5 lg:py-2 h-auto flex-shrink-0" onClick={handleAddToCart}>
