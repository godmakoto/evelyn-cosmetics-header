...
const ProductCard = ({
  ...
  return (
    <div className="bg-white rounded-none sm:rounded-2xl border-0 sm:border sm:border-[#eaeaea] border-b border-b-[#eee] overflow-hidden flex flex-row h-[240px] sm:h-[300px] md:h-[280px] shadow-none sm:hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="relative w-1/2 sm:w-[35%] md:w-[40%] bg-white flex items-start min-[520px]:items-center sm:items-center justify-center pt-3 sm:pt-0 sm:p-3 md:py-3 md:pl-3 md:pr-0 md:aspect-square md:h-auto">
        {product.discount && (
