...
const ProductCard = ({ product }: ProductCardProps) => {
  ...
  return (
    <div className="bg-white rounded-none lg:rounded-2xl border-0 lg:border lg:border-[#eaeaea] overflow-hidden flex flex-row h-[200px] sm:h-[320px] lg:h-[280px] shadow-none lg:hover:shadow-lg transition-shadow duration-300">
