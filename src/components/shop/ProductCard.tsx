...
const ProductCard = ({
  ...
  return (
    <div className="bg-white rounded-none sm:rounded-2xl border-0 sm:border sm:border-[#eaeaea] border-b border-b-[#eee] overflow-hidden flex flex-row h-[240px] sm:h-[300px] md:h-[280px] shadow-none sm:hover:shadow-lg transition-shadow duration-300">
      ...
      <div className="relative w-1/2 sm:w-[40%] md:w-[45%] bg-white flex items-center justify-center p-3 sm:p-1 md:p-0 overflow-hidden">
        {product.discount && (
        ...
        <img
          src={product.image}
          alt={product.name}
          className="w-full h-full object-contain sm:object-cover rounded-xl md:rounded-2xl"
        />
      </div>
